...
void switchKeys() //function to switch between alpha, number, and hangul
{
  switched++;
  if(switched%3==0)
  {
  ...
  else if(switched%3==1) 
  {
    image(bimg,0,0,500,500);
    number=true;
    hangul=false;
  }
  else if(switched%3==2)
  {
    image(cimg,0,0,500,500);
    number=false;
    hangul=true;
    u32.keybd_event((byte) 0x15,(byte)0xF2,0,0); //한영키를 누른다
  }
}
